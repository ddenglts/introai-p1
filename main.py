...
Does the bot, button, or fire spawn first? Does it matter?
"""
#from bot import Bot
from ship import Ship
# -1 represents cell on fire
# 0 represents closed cell
# 1 represents open cell
# 2 represents cell with button
# 3 represents cell with bot
# import random
# #consts
# ship_grid_D = 5
...
# k = 0
# fire.location = (random.randint(0,ship_grid_D-1),random.randint(0,ship_grid_D-1))
# #redo generation if fire spawns on ship
# while ship_grid[fire.location[0]][fire.location[1]] == 0:
#     fire.location = (random.randint(0,ship_grid_D-1),random.randint(0,ship_grid_D-1))

# ship_grid[fire.location[0]][fire.location[1]] == -1
